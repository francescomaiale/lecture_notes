...
\begin{spacing}{1.2}
These notes came out of the \textit{Advanced Analysis} course, held by Professor Emanuele Paolini in the second semester of the academic year 2016/2017.
...
\part{Distributions Theory}
\include{Distribution}
\include{Forier}
\include{FouLap}

\part{Applications to Partial Differential Equations}
\include{EDP}
